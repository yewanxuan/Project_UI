...
<%@ page import="com.ywx.action.*,com.ywx.bean.*,com.ywx.dao.DB"%>  
<%
        ...
        <form class="layui-form wd-form" action="info_addInfo.action" name="frm">
             <div class="layui-form-item">
                ...
                <div class="layui-input-block wd-select-block">
                    <select name="infoTypepid" id="first-level-select" 
                    	 lay-verify="required" lay-filter="level">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block wd-select-block">
                    <select name="infoAttention" lay-verify="required" value="${requestScope.infoSingle.infoAttention}" >
                        <option value="">请选择</option> 
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="infoEmail" required value="${requestScope.infoSingle.infoEmail}"  autocomplete="off" class="layui-input">
                </div>
            </div>
