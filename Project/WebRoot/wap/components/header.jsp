...
<div class="header">
    <div class="nav-center">
        <ul class="layui-nav" lay-filter="">
            ...
            <li class="layui-nav-item  wd-nav-icon">
            	<i class="layui-icon">&#xe615;</i>
            </li>
            
            <li class="layui-nav-item wd-nav-icon wa-nav-items-list">
            	<i class="layui-icon">&#xe668;</i>
            </li>
...
<div class="wd-nav-choise">
    <div class="wd-nav-choise-div">
        <c:forEach var="item" items="${sessionScope.typeMap}" end="10">
            <li class="layui-nav-item">
            	<%-- <a href="wapinfo_ListShow.action?infoType=${item.key}">${item.value}</a> --%>
            	<a href="wapinfo_SearchShow.action?subsql=info_typepid&sqlvalue=${item.key}&type=all">${item.value}</a>
            </li>
        </c:forEach>
        <div class="clearBoth"></div>
    </div>
